...
if (!isset($_SESSION['username'])) {
	...
	echo "<h2>Bạn chưa đăng nhập <a href='/Figure_shop/login.php'>Login</a> -<a href='/Figure_shop/register.php'>Register</a></h2>";
}
else
{
	echo "<h2>Xin chào: ".$_SESSION['username']."<a href='/Figure_shop/logout.php'>Logout</a></h2>";
}
?>
	...
	// {
	// 	echo "<h2>Xin chào: ".$_SESSION['user']."<a href='/Figure_shop/logout.php'>Logout</a></h2>";
	// }
	// else{
	// 	echo "<h2>Bạn chưa đăng nhập <a href='/Figure_shop/login.php'>Login</a> -<a href='/Figure_shop/register.php'>Register</a></h2>";
	// } -->
...
<div class="header-bot">
	<div class="container">
		<div class="col-md-3 header-left">
			<h1><a href="list_product.php"><img src="images/logo3.jpg"></a></h1>
		</div>
